(function(doc) {
    ...
    window.addEventListener("load", function() {
        ...
        var iframe = qs("#graph")
          ...
          , apiUrl = "https://vedantghodke.github.io/GitHub-Profile-Language-Percentage-Calculator/api.html"
          ;
        ...
        function check() {
            ...
            twitter.href = "http://twitter.com/intent/tweet?text=A pie graph with my GitHub programming languages.&url=" + escaped;
                    }
